...
Route::middleware('khachhang.auth')->group(function () {
    ...
    Route::post('/don-hang/huy/{id}', [DonHangController::class, 'huy'])->name('donhang.huy');
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/khach-hang/create', [KhachHangController::class, 'create'])->name('khachhang.create');
        Route::post('/khach-hang/store', [KhachHangController::class, 'store'])->name('khachhang.store');
        Route::get('/khach-hang/edit/{id}', [KhachHangController::class, 'edit'])->name('khachhang.edit');
        Route::put('/khach-hang/update/{id}', [KhachHangController::class, 'update'])->name('khachhang.update');
