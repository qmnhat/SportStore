                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('TieuDe') is-invalid @enderror"
                                        id="TieuDe" name="TieuDe" value="{{ old('TieuDe') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('TomTat') is-invalid @enderror"
                                        id="TomTat" name="TomTat" rows="3" placeholder="Nhập tóm tắt bài viết" required>{{ old('TomTat') }}</textarea>
                                    @error('TomTat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('NoiDung') is-invalid @enderror"
                                        id="NoiDung" name="NoiDung" rows="8" placeholder="Nhập nội dung bài viết" required>{{ old('NoiDung') }}</textarea>
                                    @error('NoiDung')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('MaDanhMuc') is-invalid @enderror"
                                        ...
                                        <option value="{{ $cat->id }}" @selected(old('MaDanhMuc') == $cat->id)>{{ $cat->TenDanhMuc }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @error('MaDanhMuc')
